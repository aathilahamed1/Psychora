...
export default function WellnessPathway() {
  ...
  if (activePathway) {
    ...
    return (
        <div className="container px-4 md:px-6 relative">
            <BackButton />
            <div className="flex flex-col items-center justify-center space-y-4 text-center mb-12 pt-12 sm:pt-0">
  ...
  if (recommendedPathway) {
    return (
        <div className="container px-4 md:px-6 relative">
            <BackButton />
             <Card className="max-w-3xl mx-auto glassmorphic-card animate-fade-in-up bg-primary/5 border-primary/20 mt-12 sm:mt-0">
